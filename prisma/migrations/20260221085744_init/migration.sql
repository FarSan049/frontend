...
CREATE TABLE `products` (
    ...
    INDEX `products_name_idcategory_idx`(`name`, `idcategory`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `testimonials` (
    ...
    INDEX `testimonials_name_idx`(`name`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `benefits` (
    ...
    UNIQUE INDEX `benefits_title_key`(`title`),
    INDEX `benefits_title_idx`(`title`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `hero` (
    ...
    UNIQUE INDEX `hero_title_key`(`title`),
    INDEX `hero_title_idx`(`title`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
