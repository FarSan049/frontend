'use server' // Kode dijalankan disisi server bukan dibrowser (Server Action)
...
export async function signUpAction(
  ...
  try {
    ...
    // mekanisme resmi Next.js untuk menhentikan eksekusi dan melakukan redirect
    // jika error tidak dilempar ulang maka proses redirect akan gagal dan malah masuk ke penanganan error umum

    // Setelahnya akan menangani error dari aplikasi
